...
class Form2(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('Смартфоны')

        self.setWindowIcon(QtGui.QIcon('images/logo.png'))
        # устанавливаем картинку label_img
        self.label_img.setPixmap(QPixmap('images/smartphone.png'))
...
class Form3(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('Электронные часы')

        self.setWindowIcon(QtGui.QIcon('images/logo.png'))
        self.label_img.setPixmap(QPixmap('images/watch.png'))
        self.label_img.setScaledContents(True)
...
class Form4(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('Электрокары')

        self.setWindowIcon(QtGui.QIcon('images/logo.png'))
        self.label_img.setPixmap(QPixmap('images/car.png'))
        self.label_img.setScaledContents(True)
...
class Form5(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.lineEdit_1.setText(str(answers[2]))
        self.lineEdit_2.setText(str(answers[1]))
        self.lineEdit_3.setText(str(answers[0]))
